...
/**
 * Represents a four-wheeler (car/jeep/SUV) in the parking system.
 * Extends Vehicle to enforce type-specific behavior and rate.
 */
public class FourWheeler extends Vehicle {

    private static final int HOURLY_RATE = 20;       // ₹20 per hour for four-wheelers
     ...
     */
    public FourWheeler(String registrationNumber, String ownerName, String contactNumber) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getRegistrationNumber(), ((FourWheeler) o).getRegistrationNumber());
    }
