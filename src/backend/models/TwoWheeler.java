...
/**
 * Represents a two-wheeler (motorcycle/scooter) in the parking system.
 * Extends Vehicle to enforce type-specific behavior and rate.
 */
public class TwoWheeler extends Vehicle {

    private static final int HOURLY_RATE = 10;       // ₹10 per hour for two-wheelers
     ...
     */
    public TwoWheeler(String registrationNumber, String ownerName, String contactNumber) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(getRegistrationNumber(), ((TwoWheeler) o).getRegistrationNumber());
    }
